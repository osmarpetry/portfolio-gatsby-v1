...
author: osmarpetry
image: /assets/img/design-patterns-cover.png
---
...
In the following image that you can have from the book or the gang of for, you can see three purposes devided by two scopes (class and object).

![Design patterns of gang of four, separeted in three purposes annd devided by two scopes](/assets/img/design-patterns-table.png)
...
I tried to a little deep over every pattern, but this will take too much time and will not be so complete as the [https://refactoring.guru/design-patterns](https://refactoring.guru/design-patterns) already has, with images, diagrams, and code examples in different languages.
